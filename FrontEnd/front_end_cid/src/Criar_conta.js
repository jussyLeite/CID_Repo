...
const Criar_conta = () => {
  ...
  const Login_repositorio = () => {
    navigate('/Login_repositorio'); // Navegue para a rota de login
  };
  const Validar_Conta = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-white">
      ...
      {/* Lado direito - Formulário de criação de conta */}
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-md">
          <h1 className="text-2xl lg:text-3xl font-bold mb-6 text-white text-center lg:text-left" 
            style={{ textDecoration: 'none' }} // Remover sublinhado do título "Criar Conta"
          >Criar Conta</h1>
          <form>
            <div className="mb-4">
              <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Email</label> {/* Cor branca no texto do rótulo */}
              <input 
                type="email" 
                id="email" 
            ...
            <div className="mb-6">
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 mb-1">Senha</label> {/* Cor branca no texto do rótulo */}
            ...
            <div className="mb-6">
              <label htmlFor="password_confirmation" className="block text-sm font-medium text-gray-700 mb-1">Confirmação de Senha</label> {/* Cor branca no texto do rótulo */}
              <div className="relative">
                <input 
                  type="password" 
          ...
          <div className="mt-4 text-center">
            <a href="/Login_repositorio" className="text-sm text-red-800 hover:underline" style={{ textDecoration: 'none' }}>Já tem uma Conta?</a>
          </div>
        </div>
      </div>
    </div>
